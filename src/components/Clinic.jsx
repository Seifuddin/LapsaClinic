          ...
          {clinics.map((clinic, index) => {
            ...
            return (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="flex flex-col justify-between bg-blue-50 roundedmd shadow-md hover:shadow-xl transition-shadow duration-300 p-8 text-center border border-gray-300"
              >
                <div>
                  {/* Icon */}
