          ...
          {clinics.map((clinic, index) => {
            ...
            return (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="flex flex-col justify-between bg-white rounded-md shadow-xl hover:shadow-xl transition-shadow duration-300 p-8 text-center border border-gray-200"
              >
                <div>
                  {/* Icon */}
